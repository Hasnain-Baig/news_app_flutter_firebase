...
class Headlines extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<BottomNavbarController>(builder: (_) {
      return !_bottomNavbarController.activeCon
          ...
          : GetBuilder<HeadlinesController>(builder: (_) {
              return Container(
                padding: EdgeInsets.symmetric(vertical: 10, horizontal: 5),
                child: SingleChildScrollView(
                  physics: ScrollPhysics(),
                  child: Column(
                    children: [buildHeadlinesContainer(context)],
                  ),
                ),
              );
            });
  ...
  Widget buildHeadlinesContainer(context) {
    return Container(
      padding: EdgeInsets.symmetric(vertical: 10, horizontal: 5),
      child: FutureBuilder<List>(
          future: _headlinesController.headlines,
