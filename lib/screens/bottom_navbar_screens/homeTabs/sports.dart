...
class Sports extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<BottomNavbarController>(builder: (_) {
      return !_bottomNavbarController.activeCon
          ...
          : GetBuilder<SportsNewsController>(builder: (_) {
              return Container(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      buildSportsNewsContainer(context),
                    ],
                  ),
                ),
              );
  ...
  Widget buildSportsNewsContainer(context) {
    return Container(
      padding: EdgeInsets.symmetric(vertical: 10, horizontal: 5),
      child: FutureBuilder<List>(
          future: _sportsNewsController.sportsNews,
